/*
  ...
  - You are about to drop the column `goal` on the `ClientProfile` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "goal" "Goal" NOT NULL;
